    ...
    */
    ...
    describe('The Menu', function(){
        ...
        it('is hidden by css', function(){
          ...
          */
         it('gets hidden when menu button is clicked and shown with second click', function(){
    ...
    describe('Initial Entries', function() {
        ...
        it('has one or more .entry within .feed', function() {
            let entry = $('.entry');
    ...
    describe('New Feed Section', function() {
       ...
       it('ensures content changes when running loadFeed()', function() {
           newFeed = $('.feed').html();
